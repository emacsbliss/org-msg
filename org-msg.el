...
(defconst org-msg-default-style
  ...
  `((del nil (,@font (color . "grey") (border-left . "none")
    ...
    (li nil (,@font ,line-height (margin-bottom . "5px")
	     (margin-top . "2px")))
    (nil org-ul ((list-style-type . "square")))
    (nil org-ol (,@font ,line-height (margin-bottom . "5px")
    ...
    (h4 nil ((margin-bottom . "5px") (font-size . "11pt")
	     ,font-family))
    (h3 nil ((margin-bottom . "5px") (text-decoration . "underline")
    ...
    (h1 nil ((margin-top . "20px")
	     (margin-bottom . "5px") ,color (font-size . "12pt")
	     ,font-family))
    (p nil ((text-decoration . "none") (margin-bottom . "10px")
	    (margin-top . "10px") (line-height . "150%") ,font-size
	    ,font-family))
